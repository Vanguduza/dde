...
COMMAND_SCOPES: Final[dict[str, str]] = {
    ...
    "frontend.project.switch": "mission.read",
    ...
    "frontend.preview.set_scenario": "mission.control",
    "frontend.comment.create": "mission.control",
    "frontend.comment.resolve": "mission.control",
    "frontend.editor.set_assist": "mission.control",
    "frontend.attention.acknowledge": "mission.control",
    ...
    "vekl.openai.install_catalog_candidates": "mission.control",
    "vekl.playbook.install_candidates": "mission.control",
    "vekl.playbook.qualify": "mission.control",
...
COMMAND_TARGET_TYPE: Final[dict[str, str]] = {
    ...
    "frontend.project.switch": "project",
    ...
    "frontend.preview.set_scenario": "mission",
    "frontend.comment.create": "mission",
    "frontend.comment.resolve": "mission",
    "frontend.editor.set_assist": "mission",
    "frontend.attention.acknowledge": "mission",
    ...
    "vekl.openai.install_catalog_candidates": "mission",
    "vekl.playbook.install_candidates": "mission",
    "vekl.playbook.qualify": "mission",

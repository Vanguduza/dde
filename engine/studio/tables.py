...
frontend_conversations = Table(
    ...
    Column("active_worker_session_id", Uuid(as_uuid=True), nullable=True),
    Column("context_domain", Text, nullable=True),
    Column("active_task_id", Uuid(as_uuid=True), nullable=True),
    Column("active_worker_run_id", Uuid(as_uuid=True), nullable=True),
    Column("active_verification_run_id", Uuid(as_uuid=True), nullable=True),
    Column("active_artifact_ref", Text, nullable=True),
...
frontend_chat_checkpoints = Table(
    ...
    Column("conversation_context", JSONB, nullable=True),

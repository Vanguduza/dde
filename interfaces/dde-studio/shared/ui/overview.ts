...
export function overviewStyles(): string {
  ...
  return `
    ...
    .ov-tone-active { color: var(--accent-bright); }
    ...
    .ov-dot-ready { background: var(--accent-bright); }

...
**Zie619 automation-corpus Rev 2 integration (AD-050 / EDR-0018):** delivery remains inside the existing DDE-075/076/077/080/081/082/083 ownership. DDE-075 owns source reconnaissance, DDE-076 domain-neutral source admission/quarantine, DDE-077 immutable source/derived change identity, DDE-080 deterministic `WORKFLOW_AUTOMATION` GraphRAG + bounded context, DDE-081 operator projection, DDE-082 qualified target-runtime automation capability/authoring surfaces, and DDE-083 acquisition/supply-chain/polarity/RLS/revocation/stale-race certification. Scale is gated 10 -> 100 -> full admitted snapshot and must not overclaim broader Production VEKL completion.

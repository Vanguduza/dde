...
> (`edr_id=01a02e5d-cc96-730e-99c3-cc9d69a22415`, owner project
...
> outranks it. Acceptance authorizes the `INTENTIONALLY_STOPPED` recovery
> classification and its governed row (`acknowledge_stop`,
> `requires_human=True`, no automatic retry, no new WorkerRun until an
> operator acknowledges), replacing the borrowed
> `KILL_FLAG_ACTIVE → AUTHORIZATION_FAILURE` mapping.
